...
class SimpleSeq2Seq(Model):
    """
    Monkey-patch allennlp's SimpleSeq2Seq class to use multiple beams for P and
    R Bleu calculation
    """
    ...
    def __init__(self,
        ...
        self.s_bleu4 = NLTKSentenceBLEU(n_hyps=beam_size, smoothing_function=SmoothingFunction().method7,
    ...
    def forward(self,  # type: ignore
        ...
        if not self.training:
            ...
            if target_tokens:
                ...
                self.s_bleu4(top_k_predictions, target_tokens["tokens"])
                self.n_bleu2(top_k_predictions, target_tokens["tokens"])
    ...
    def get_metrics(self, reset: bool = False) -> Dict[str, float]:
        ...
        if not self.training:
            all_metrics.update(self.s_bleu4.get_metric(reset=reset))
            all_metrics.update(self.n_bleu2.get_metric(reset=reset))
        return all_metrics
